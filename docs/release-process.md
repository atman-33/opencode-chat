...
- Do not edit generated assets under `out/`; always release from a clean build on CI.
...
- `.github/workflows/on-pr.yml` – Runs CI (install dependencies and compile) on pushes to `main` and on pull requests.
